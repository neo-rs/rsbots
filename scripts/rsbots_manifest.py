...
def _load_manifest_lib(repo_root: Path):
    """Load the top-level rsbots_manifest.py without name-collisions with this script."""
    lib_path = repo_root / "rsbots_manifest.py"
...
def main() -> None:
    ...
    lib = _load_manifest_lib(repo_root)
    ...
    manifest = generate_manifest(repo_root, bot_folders=bot_folders)

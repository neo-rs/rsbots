...
## 🏰 Discord Guild IDs (source of truth)

These are the canonical Discord guild/server IDs used across this repo. Do not “guess” or hardcode IDs elsewhere—wire them through each bot’s config.

- **Reselling Secrets**: `876528050081251379`
- **Mirror World**: `1431314516364230689`
- **Neo Test Server**: `1451275225512546497`

Where they live in config (canonical):

- `RSAdminBot/config.json`
  - `rs_server_guild_id` = Reselling Secrets
  - `test_server_guild_id` = Neo Test Server
